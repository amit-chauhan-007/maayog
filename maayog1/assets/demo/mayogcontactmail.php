...
if($uname !='' && $uemail !='' && $subject !='' && $phone !='')
{

$to = 'info@maayog.com';
$subject = "Mayog Contactus Enquiry";
$message ='<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<head>
<title>Quanutrition.com</title>
<style type="text/css">
div, p, a, li, td {
              ...
              <tr>
                <td><table border="0" cellspacing="0" cellpadding="0" align="left" class="inner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                    <tr>
                      ...
                      <td height="75" class="inner" valign="middle"><a href="#"><img class="logo" src="http://maayog.com/demo/images/logo1.jpg" width="180" height="61" alt="Logo" style="background: #000;padding: 10px;"></a></td>
                    </tr>
                  </table>
                  <table width="150" border="0" cellspacing="0" cellpadding="0" align="right" class="inner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                    ...
                    <tr>
                      <td align="center"><a href="http://maayog.com/demo/" class="top-button" style="font:bold 13px/37px Arial, Helvetica, sans-serif; color:#ffffff; text-decoration:none; background:#f47920; display:block; border-radius:24px; text-transform:uppercase;">View online</a></td>
                    ...
                    <tr>
                      ...
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="inner">
                          ...
                          <tr>
                            ...
                            <td style="font:15px/19px Arial, Helvetica, sans-serif;padding-bottom: 8px;color: #000;" class="smallfont" width="23">'.$phone.'</td>
                          </tr>
                          <tr>
                            <td style="font:15px/19px Arial, Helvetica, sans-serif;padding-bottom: 8px;color: #000;" class="smallfont">Subject</td>
                            <td style="font:15px/19px Arial, Helvetica, sans-serif;padding-bottom: 8px;color: #000;" class="smallfont" width="23">'.$subject.'</td>
                          </tr>
                          <tr>
                      ...
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="full">
                                <tr>
                                  <td align="center" style="font:11px Helvetica,  Arial, sans-serif; color:#ffffff;"><a style="color:#000000; text-decoration:none;" href="#"> View in browser</a></td>
                                  <td style="color:#000000;"> | </td>
                                  <td align="center" style="font:11px Helvetica,  Arial, sans-serif; color:#ffffff;"><a style="color:#000000; text-decoration:none;" href="#"> Unsubscribe</a></td>
                                  <td style="color:#000000;"> | </td>
                                  <td align="center" style="font:11px Helvetica,  Arial, sans-serif; color:#ffffff;"><a style="color:#000000; text-decoration:none;" href="#"> Send to a friend</a></td>
...
$headers .= 'From: info@maayog.com' . "\r\n";
$headers .= 'Reply-to: '.$uemail.'' . "\r\n";
$headers .= 'Cc: rajendra.b@purpledot.in' . "\r\n";
$sent = mail($to,$subject,$message,$headers);
  echo "Thankyou for Contact with us. We will get back you soon !!.";
}
else
{
